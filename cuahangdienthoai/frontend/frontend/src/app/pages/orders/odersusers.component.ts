...
//   private readonly API = 'https://localhost:7152/api/orders';
...
//     // ✅ Luôn gọi API lấy data mới nhất thay vì dùng cache
//     this.http.get<Order>(`${this.API}/my/${order.orderID}`).subscribe({
//       next: o => {
//         this.selectedOrder = o;
//         // ✅ Cập nhật luôn vào danh sách để payment status hiển thị đúng
...
//     setTimeout(() => { this.toast.show = false; this.cdr.detectChanges(); }, 2800);
//   }
// }
...
// odersusers.component.ts  ← PHIÊN BẢN ĐÃ FIX
import { Component, OnInit, ChangeDetectorRef } from '@angular/core';
import { CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms';
import { HttpClient } from '@angular/common/http';
...
export class OrdersUsersComponent implements OnInit {
  private readonly API = 'https://localhost:7152/api/orders';
  private readonly PAYMENT_API = 'https://localhost:7152/api/payments';
